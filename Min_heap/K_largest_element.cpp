...
void k_largest(int* val, int l, int k)
{
    if(k > l)
    {
        cout<<"Already the desired list of elements\n";
        return;
    }

    minheap* h= initHeapfromArray(val, k);
    ...
    cout<<endl<<"Largest "<<k<<" elements are\n";
    for(int i=0; i<k; i++)
        cout<<h->harray[i]<<" ";
    cout<<endl;
}
...
//***************************************OUTPUT******************************************
heap is full
Elements in heap after normal Insertion
1 2 3 4 5 8 12 9 7 

The vals array is 
12 3 18 14 5 9 1 7 2 13 

Elements in heap after insertion through array
3 5 18 14 12 

Largest 5 elements are
9 12 18 14 13 
